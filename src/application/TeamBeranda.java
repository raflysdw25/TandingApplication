...
public class TeamBeranda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tb_pertandingan = new javax.swing.JTable();
        ...
        pnl_teamProfileLayout.setVerticalGroup(
            ...
            .addGroup(pnl_teamProfileLayout.createSequentialGroup()
                ...
                .addGroup(pnl_teamProfileLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addGroup(pnl_teamProfileLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jScrollPane3.setViewportView(tb_pertandingan);
...
//            tb_search.setModel(new DefaultTableModel());
    ...
    private void btn_editProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editProfileActionPerformed
        // TODO add your handling code here:
        new UpdateTeam(id_team).setVisible(true);
        this.dispose();
    ...
    public void readDataPertandingan(){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Belum Ada pertandingan");
        }finally{
            try{
                rs.close();
                pst.close();
    ...
    private javax.swing.JTable tb_pertandingan;
